...
// Removed ProductionWarning - keeping it simple
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-800 to-gray-600">
      <div className={`container ${isMobileDevice ? 'max-w-full px-1' : 'max-w-6xl px-4'} mx-auto pt-4 sm:pt-8 pb-4 sm:pb-8`}>
        ...
        {/* Navigation Tabs */}
        <div className="flex flex-wrap gap-1 mb-8 bg-slate-800/50 p-1 rounded-lg overflow-x-auto">
          <button
            ...
            <div className="mb-8">
              <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/20">
                <div className="flex flex-wrap gap-2">
                  ...
                  >
                    Cultural Events ({events.filter(e => e.type === 'art').length})
                  </button>
                  <button
                  ...
                  >
                    Tech Events ({events.filter(e => e.type === 'tech').length})
                  </button>
                  <button
                  ...
                  >
                    Science Events ({events.filter(e => e.type === 'science').length})
                  </button>
                </div>
              </div>
            </div>
