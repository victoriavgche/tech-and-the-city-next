...
import { Save, ArrowLeft, Eye, AlertCircle, Bold, Italic, List, ListOrdered, Quote, Code, Link as LinkIcon, Heading1, Heading2, Heading3, Type, Image, Video, Upload, X, Plus, Underline, Strikethrough, Palette, Highlighter, AlignLeft, AlignCenter, AlignRight, AlignJustify, Minus } from 'lucide-react';
...
`;
      ...
      if (response.ok) {
        ...
        setError(`Failed to create article: ${responseData.error || 'Unknown error'}`);
      }
    } catch (error) {
      ...
      <div className="container max-w-4xl mx-auto px-4">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-400 mt-2">Write and publish a new article</p>
          </div>
        ...
        <div className="bg-slate-800 rounded-lg border border-slate-700">
          <div className="p-4 border-b border-slate-700">
            ...
            <p className="text-gray-400 text-sm">Write your article with formatting options</p>
          </div>
