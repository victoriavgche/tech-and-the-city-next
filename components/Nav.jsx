    ...
    <nav className="sticky top-0 z-40 bg-gray-800 border-b border-gray-700">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        <div className="hidden md:flex items-center justify-between">
          <Logo />
          <div className="flex items-center gap-8 lg:gap-12 text-base lg:text-lg text-white">
            <a 
        ...
        <div className="md:hidden flex items-center justify-between">
          ...
          <div className="flex-1 flex justify-center px-2">
            <a href="/" className="text-white text-2xl font-bold tracking-wide hover:text-blue-400 transition-colors text-center" style={{
              ...
              TECH <span style={{ fontWeight: '400', fontSize: '0.9rem' }}>&</span> THE CITY
            </a>
          </div>
